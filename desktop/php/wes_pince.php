    <div class="col-lg-9 eqLogic wes_pince" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
        ...
        <table id="table_cmd_wes_pince" class="table table-bordered table-condensed wes_pince">
            <thead>
                <tr>
