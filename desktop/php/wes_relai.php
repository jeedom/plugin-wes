    <div class="col-lg-9 eqLogic wes_relai" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
        ...
        <table id="table_cmd_wes_relai" class="table table-bordered table-condensed wes_relai">
            <thead>
                <tr>
