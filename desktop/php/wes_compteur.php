    <div class="col-lg-9 eqLogic wes_compteur" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
        ...
        <table id="table_cmd_wes_compteur" class="table table-bordered table-condensed wes_compteur">
            <thead>
                <tr>
