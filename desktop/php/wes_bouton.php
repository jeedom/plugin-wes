    <div class="col-lg-9 eqLogic wes_bouton" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
        ...
        <table id="table_cmd_wes_bouton" class="table table-bordered table-condensed wes_bouton">
            <thead>
                <tr>
