    <div class="col-lg-9 eqLogic wes_analogique" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
        ...
        <table id="table_cmd_wes_analogique" class="table table-bordered table-condensed wes_analogique">
            <thead>
                <tr>
